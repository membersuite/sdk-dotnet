...
namespace MemberSuite.SDK.Searching.Operations
{
    public static class Expr
    {
        ...
        {
            var so = new StartsWithOneOfTheFollowing
            {
                FieldName = field,
                ValuesToOperateOn = new List<object>(listOfValues)
            };
            return so;
        }
        ...
        {
            var so = new DoesNotStartWithOneOfTheFollowing
            {
                FieldName = field,
                ValuesToOperateOn = new List<object>(listOfValues)
            };
        ...
        {
            var so = new EndsWithOneOfTheFollowing
            {
                FieldName = field,
                ValuesToOperateOn = new List<object>(listOfValues)
            };
        ...
        {
            var so = new DoesNotEndWithOneOfTheFollowing
            {
                FieldName = field,
                ValuesToOperateOn = new List<object>(listOfValues)
            };
