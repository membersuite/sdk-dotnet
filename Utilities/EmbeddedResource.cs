...
namespace MemberSuite.SDK.Utilities
{
    ...
    public static class EmbeddedResource
    {
        ...
        public static XmlReader LoadAsXml( string templateName )
        {
            // first get the raw string
            string xmlFile = LoadAsString( templateName, Assembly.GetCallingAssembly() );
        ...
        {
            // first get the raw string
            string xmlFile = LoadAsString(templateName, callingAssembly);
        ...
        public static string LoadAsString( string templateName, Assembly callingAssembly )
        {
          ...
          //  leave this out for now if (_resourceCache.TryGetValue(templateName, out result))
            ...
            Stream stream = callingAssembly.GetManifestResourceStream( templateName );
        ...
        {
            Stream stream = Assembly.GetCallingAssembly().GetManifestResourceStream(templateName);
