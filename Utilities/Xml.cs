...
namespace MemberSuite.SDK.Utilities
{
    ...
    public static class Xml
    {
        ...
        {
            var dz = new DataContractSerializer(objectToSerialize.GetType());
        ...
        {
            var dz = new DataContractSerializer(typeof (T));
        ...
        public static T DeserializeWithNodeReader<T>(XmlNode source)
        {
            ...
            var result = serializer.Deserialize(new XmlNodeReader(source));
            // source.Close();
