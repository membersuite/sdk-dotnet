...
namespace MemberSuite.SDK.Types
{
    ...
    public class MemberSuiteObject : IPropertyOrFieldNodeOverrideable, ICustomTypeDescriptor
    {
        ...
        public bool SetValue(string expression, object newValue)
        {
            ...
            if (!CanAdd(newValue))
                throw new SDKException("Unable to add type '{0}' to a MemberSuite object - it cannot be serialized.", newValue.GetType());
            ...
            try
            {
                IExpression expr = SpringExpression.GetExpressionFor(expression);
        ...
        private static void initialize()
        {
            ...
            foreach (Type t in registerKnownTypes())
            {
        ...
        {
            List<Type> allowableTypes = new List<Type>();
            ...
            allowableTypes.Add(typeof(DashboardMetadata));
            ...
            allowableTypes.Add(typeof(KPIType));
            allowableTypes.Add(typeof(BillingScheduleEntryStatus));
            allowableTypes.Add(typeof(KPIPeriod));
            allowableTypes.Add(typeof(AccountingMethod));
            ...
            allowableTypes.Add(typeof(COGSPolicy));
        ...
        {
            MemberSuiteObject result = new MemberSuiteObject();
        ...
        {
            MemberSuiteObject mso = new MemberSuiteObject { ClassType = this.ClassType, ParentTypes = ParentTypes };
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            PropertyDescriptor[] properties = new PropertyDescriptor[Fields.Count];
        ...
        public class MemberSuiteObjectFieldDescriptor : PropertyDescriptor
        {
            ...
            {
                MemberSuiteObject mso = component as MemberSuiteObject;
                if (mso != null)
        ...
        public static MemberSuiteObject ConvertToMemberSuiteObject(MemberSuiteObject memberSuiteObject)
        {
            ...
            MemberSuiteObject clone = memberSuiteObject.Clone();
            ...
            if (clone.Fields != null)
                foreach (var entry in clone.Fields)
                {
                    ...
                    {
                        List<MemberSuiteObject> objects = new List<MemberSuiteObject>();
                        foreach (var listEntry in (IEnumerable)entry.Value)
                            objects.Add(MemberSuiteObject.ConvertToMemberSuiteObject((MemberSuiteObject)listEntry));
    ...
    public static class MemberSuiteObjectExtensions
    {
        ...
        public static List<T> ConvertTo<T>(this List<MemberSuiteObject> listOfMemberSuiteObjects) where T : msDomainObject
        {
            if (listOfMemberSuiteObjects == null)
                return null;

            var ci = typeof(T).GetConstructor(new Type[] { typeof(MemberSuiteObject) });
        ...
        public static MemberSuiteObject ConvertTo(this MemberSuiteObject mso, Type t)
        {
            ...
            var ci = t.GetConstructor(new Type[] { typeof(MemberSuiteObject) });
            if (ci == null) throw new Exception("no contructor found for " + t.FullName);


            MemberSuiteObject newMSO = (MemberSuiteObject)ci.Invoke(new object[] { mso });
